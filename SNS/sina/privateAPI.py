...
class privateAPI(object):
	...
	def get_other_weibo_data(self, other_uid):
		data_url = self.api_host + self.api_root + 'statuses/user_timeline.json?access_token=' + self.access_token + '&uid=' + str(other_uid)
		r = requests.get(data_url)
		return r.text
